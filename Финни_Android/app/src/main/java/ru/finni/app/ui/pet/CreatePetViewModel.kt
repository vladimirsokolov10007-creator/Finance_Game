...
class CreatePetViewModel @Inject constructor(
    ...
    fun onColorChange(index: Int) = _uiState.update { it.copy(color = index) }
    fun onAccessoryChange(index: Int) = _uiState.update { it.copy(accessory = index) }
